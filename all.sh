...
./run.sh 2 >/dev/null 2>/dev/null &
./run.sh 3 >/dev/null 2>/dev/null &

sleep 3

bin/kafka-topics.sh --zookeeper localhost:42181 --topic apples --replication-factor 1 --partitions 1 --create
bin/kafka-topics.sh --zookeeper localhost:42181 --topic bananas --replication-factor 3 --partitions 1 --create
