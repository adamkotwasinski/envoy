...
cp -v bazel-out/darwin_arm64-fastbuild/bin/contrib/kafka/filters/network/source/external/requests.cc .
cp -v bazel-out/darwin_arm64-fastbuild/bin/contrib/kafka/filters/network/source/external/responses.h .
cp -v bazel-out/darwin_arm64-fastbuild/bin/contrib/kafka/filters/network/source/external/responses.cc .
