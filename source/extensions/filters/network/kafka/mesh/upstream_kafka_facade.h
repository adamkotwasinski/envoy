...
public:
  UpstreamKafkaFacade(const ClusteringConfiguration& clustering_configuration, ThreadLocal::SlotAllocator& tls_allocator, Thread::ThreadFactory& thread_factory);
