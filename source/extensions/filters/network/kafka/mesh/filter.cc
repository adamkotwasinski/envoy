...
KafkaMeshFilter::KafkaMeshFilter(const ClusteringConfiguration& clustering_configuration, UpstreamKafkaFacade& upstream_kafka_facade):
    request_decoder_{new RequestDecoder({std::make_shared<RequestHandler>(*this)})},
    clustering_configuration_{clustering_configuration},
    request_in_flight_factory_{*this, clustering_configuration},
