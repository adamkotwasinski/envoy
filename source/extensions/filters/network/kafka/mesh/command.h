...
public:
  ...
  MetadataRequestHolder(AbstractRequestListener& filter, const ClusteringConfiguration& clustering_configuration, const std::shared_ptr<Request<MetadataRequest>> request);
