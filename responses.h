...
struct AbortedTransaction {
  ...
  // constructor used in versions: [12, 13]
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 4 && api_version < 14) {
    ...
    if (api_version >= 12 && api_version < 14) {
      written += encoder.computeCompactSize(tagged_fields_);
    }
...
struct FetchResponseResponsePartitionData {
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 5 && api_version < 14) {
      written += encoder.computeSize(log_start_offset_);
    }
    ...
    if (api_version >= 11 && api_version < 14) {
...
struct FetchableTopicResponse {
  ...
  // constructor used in versions: [13]
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 13 && api_version < 14) {
...
struct FetchResponse {
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 1 && api_version < 14) {
      written += encoder.computeSize(throttle_time_ms_);
    }
    
    if (api_version >= 7 && api_version < 14) {
      written += encoder.computeSize(error_code_);
    }
...
struct JoinGroupResponse {
  ...
  // constructor used in versions: [0, 1]
  JoinGroupResponse(int16_t error_code, int32_t generation_id, std::string protocol_name, std::string leader, std::string member_id, std::vector<JoinGroupResponseMember> members): throttle_time_ms_{0}, error_code_{error_code}, generation_id_{generation_id}, protocol_type_{absl::nullopt}, protocol_name_{absl::make_optional(protocol_name)}, leader_{leader}, member_id_{member_id}, members_{members}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [2, 3, 4, 5]
  JoinGroupResponse(int32_t throttle_time_ms, int16_t error_code, int32_t generation_id, std::string protocol_name, std::string leader, std::string member_id, std::vector<JoinGroupResponseMember> members): throttle_time_ms_{throttle_time_ms}, error_code_{error_code}, generation_id_{generation_id}, protocol_type_{absl::nullopt}, protocol_name_{absl::make_optional(protocol_name)}, leader_{leader}, member_id_{member_id}, members_{members}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [6]
  JoinGroupResponse(int32_t throttle_time_ms, int16_t error_code, int32_t generation_id, std::string protocol_name, std::string leader, std::string member_id, std::vector<JoinGroupResponseMember> members, TaggedFields tagged_fields): throttle_time_ms_{throttle_time_ms}, error_code_{error_code}, generation_id_{generation_id}, protocol_type_{absl::nullopt}, protocol_name_{absl::make_optional(protocol_name)}, leader_{leader}, member_id_{member_id}, members_{members}, tagged_fields_{tagged_fields} {};
  // constructor used in versions: [7]
  JoinGroupResponse(int32_t throttle_time_ms, int16_t error_code, int32_t generation_id, absl::optional<std::string> protocol_type, absl::optional<std::string> protocol_name, std::string leader, std::string member_id, std::vector<JoinGroupResponseMember> members, TaggedFields tagged_fields): throttle_time_ms_{throttle_time_ms}, error_code_{error_code}, generation_id_{generation_id}, protocol_type_{protocol_type}, protocol_name_{protocol_name}, leader_{leader}, member_id_{member_id}, members_{members}, tagged_fields_{tagged_fields} {};
...
struct AddPartitionsToTxnPartitionResult {
  ...
  // constructor used in versions: [0, 1, 2]
  AddPartitionsToTxnPartitionResult(int32_t partition_index, int16_t error_code): partition_index_{partition_index}, error_code_{error_code}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [3]
  AddPartitionsToTxnPartitionResult(int32_t partition_index, int16_t error_code, TaggedFields tagged_fields): partition_index_{partition_index}, error_code_{error_code}, tagged_fields_{tagged_fields} {};
...
struct AddPartitionsToTxnTopicResult {
  ...
  const std::string name_;
  const std::vector<AddPartitionsToTxnPartitionResult> results_;
  const TaggedFields tagged_fields_;
  
  // constructor used in versions: [0, 1, 2]
  AddPartitionsToTxnTopicResult(std::string name, std::vector<AddPartitionsToTxnPartitionResult> results): name_{name}, results_{results}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [3]
  AddPartitionsToTxnTopicResult(std::string name, std::vector<AddPartitionsToTxnPartitionResult> results, TaggedFields tagged_fields): name_{name}, results_{results}, tagged_fields_{tagged_fields} {};
...
struct AddPartitionsToTxnResponse {
  ...
  const int32_t throttle_time_ms_;
  const std::vector<AddPartitionsToTxnTopicResult> results_;
  const TaggedFields tagged_fields_;
  
  // constructor used in versions: [0, 1, 2]
  AddPartitionsToTxnResponse(int32_t throttle_time_ms, std::vector<AddPartitionsToTxnTopicResult> results): throttle_time_ms_{throttle_time_ms}, results_{results}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [3]
  AddPartitionsToTxnResponse(int32_t throttle_time_ms, std::vector<AddPartitionsToTxnTopicResult> results, TaggedFields tagged_fields): throttle_time_ms_{throttle_time_ms}, results_{results}, tagged_fields_{tagged_fields} {};
...
struct DescribeLogDirsResult {
  ...
  // constructor used in versions: [0, 1]
  DescribeLogDirsResult(int16_t error_code, std::string log_dir, std::vector<DescribeLogDirsTopic> topics): error_code_{error_code}, log_dir_{log_dir}, topics_{topics}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [2]
  DescribeLogDirsResult(int16_t error_code, std::string log_dir, std::vector<DescribeLogDirsTopic> topics, TaggedFields tagged_fields): error_code_{error_code}, log_dir_{log_dir}, topics_{topics}, tagged_fields_{tagged_fields} {};
...
struct DescribeLogDirsResponse {
  ...
  // constructor used in versions: [0, 1]
  DescribeLogDirsResponse(int32_t throttle_time_ms, std::vector<DescribeLogDirsResult> results): throttle_time_ms_{throttle_time_ms}, results_{results}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [2]
  DescribeLogDirsResponse(int32_t throttle_time_ms, std::vector<DescribeLogDirsResult> results, TaggedFields tagged_fields): throttle_time_ms_{throttle_time_ms}, results_{results}, tagged_fields_{tagged_fields} {};
...
struct CreateDelegationTokenResponse {
  ...
  // constructor used in versions: [0, 1]
  CreateDelegationTokenResponse(int16_t error_code, std::string principal_type, std::string principal_name, int64_t issue_timestamp_ms, int64_t expiry_timestamp_ms, int64_t max_timestamp_ms, std::string token_id, Bytes hmac, int32_t throttle_time_ms): error_code_{error_code}, principal_type_{principal_type}, principal_name_{principal_name}, issue_timestamp_ms_{issue_timestamp_ms}, expiry_timestamp_ms_{expiry_timestamp_ms}, max_timestamp_ms_{max_timestamp_ms}, token_id_{token_id}, hmac_{hmac}, throttle_time_ms_{throttle_time_ms}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [2]
  CreateDelegationTokenResponse(int16_t error_code, std::string principal_type, std::string principal_name, int64_t issue_timestamp_ms, int64_t expiry_timestamp_ms, int64_t max_timestamp_ms, std::string token_id, Bytes hmac, int32_t throttle_time_ms, TaggedFields tagged_fields): error_code_{error_code}, principal_type_{principal_type}, principal_name_{principal_name}, issue_timestamp_ms_{issue_timestamp_ms}, expiry_timestamp_ms_{expiry_timestamp_ms}, max_timestamp_ms_{max_timestamp_ms}, token_id_{token_id}, hmac_{hmac}, throttle_time_ms_{throttle_time_ms}, tagged_fields_{tagged_fields} {};
...
struct ReplicaState {
  ...
  // constructor used in versions: [0]
  ReplicaState(int32_t replica_id, int64_t log_end_offset, TaggedFields tagged_fields): replica_id_{replica_id}, log_end_offset_{log_end_offset}, tagged_fields_{tagged_fields} {};
...
struct ResponsePartitionData {
  ...
  const int32_t current_isr_version_;
  const TaggedFields tagged_fields_;
  
  // constructor used in versions: [0]
  ResponsePartitionData(int32_t partition_index, int16_t error_code, int32_t leader_id, int32_t leader_epoch, std::vector<int32_t> isr, int32_t current_isr_version, TaggedFields tagged_fields): partition_index_{partition_index}, error_code_{error_code}, leader_id_{leader_id}, leader_epoch_{leader_epoch}, isr_{isr}, current_isr_version_{current_isr_version}, tagged_fields_{tagged_fields} {};
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 0 && api_version < 1) {
      written += encoder.computeSize(current_isr_version_);
    }
  ...
  uint32_t encode(Buffer::Instance& dst, EncodingContext& encoder) const {
    ...
    if (api_version >= 0 && api_version < 1) {
      written += encoder.encode(current_isr_version_, dst);
    }
  ...
  bool operator==(const ResponsePartitionData& rhs) const {
    ...
    && leader_epoch_ == rhs.leader_epoch_
    && isr_ == rhs.isr_
    && current_isr_version_ == rhs.current_isr_version_
    && tagged_fields_ == rhs.tagged_fields_;
  };
...
struct ResponseTopicData {
  ...
  // constructor used in versions: [0]
  ResponseTopicData(std::string name, std::vector<ResponsePartitionData> partitions, TaggedFields tagged_fields): name_{name}, partitions_{partitions}, tagged_fields_{tagged_fields} {};
...
struct AlterIsrResponse {
  ...
  // constructor used in versions: [0]
  AlterIsrResponse(int32_t throttle_time_ms, int16_t error_code, std::vector<ResponseTopicData> topics, TaggedFields tagged_fields): throttle_time_ms_{throttle_time_ms}, error_code_{error_code}, topics_{topics}, tagged_fields_{tagged_fields} {};
  ...
  bool operator==(const AlterIsrResponse& rhs) const {
...
class AlterIsrResponseV0Deserializer:
  public CompositeDeserializerWith4Delegates<
    AlterIsrResponse
    ,
      Int32Deserializer
...
class AlterIsrResponseV0Parser:
  public ResponseDataParser<
    AlterIsrResponse, AlterIsrResponseV0Deserializer>{
public:
  AlterIsrResponseV0Parser(ResponseContextSharedPtr context):
    ResponseDataParser{context} {};
};
