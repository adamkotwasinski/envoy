...
struct FetchPartition {
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 9 && api_version < 14) {
...
struct FetchRequest {
  ...
  uint32_t computeSize(const EncodingContext& encoder) const {
    ...
    if (api_version >= 3 && api_version < 14) {
...
struct LeaderAndIsrRequest {
  ...
  // constructor used in versions: [0, 1]
  LeaderAndIsrRequest(int32_t controller_id, int32_t controller_epoch, std::vector<LeaderAndIsrPartitionState> ungrouped_partition_states, std::vector<LeaderAndIsrLiveLeader> live_leaders): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{-1}, type_{0}, ungrouped_partition_states_{ungrouped_partition_states}, topic_states_{std::vector<LeaderAndIsrTopicState>{}}, live_leaders_{live_leaders}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [2, 3]
  LeaderAndIsrRequest(int32_t controller_id, int32_t controller_epoch, int64_t broker_epoch, std::vector<LeaderAndIsrTopicState> topic_states, std::vector<LeaderAndIsrLiveLeader> live_leaders): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{broker_epoch}, type_{0}, ungrouped_partition_states_{std::vector<LeaderAndIsrPartitionState>{}}, topic_states_{topic_states}, live_leaders_{live_leaders}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [4]
  LeaderAndIsrRequest(int32_t controller_id, int32_t controller_epoch, int64_t broker_epoch, std::vector<LeaderAndIsrTopicState> topic_states, std::vector<LeaderAndIsrLiveLeader> live_leaders, TaggedFields tagged_fields): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{broker_epoch}, type_{0}, ungrouped_partition_states_{std::vector<LeaderAndIsrPartitionState>{}}, topic_states_{topic_states}, live_leaders_{live_leaders}, tagged_fields_{tagged_fields} {};
  // constructor used in versions: [5, 6]
  LeaderAndIsrRequest(int32_t controller_id, int32_t controller_epoch, int64_t broker_epoch, int8_t type, std::vector<LeaderAndIsrTopicState> topic_states, std::vector<LeaderAndIsrLiveLeader> live_leaders, TaggedFields tagged_fields): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{broker_epoch}, type_{type}, ungrouped_partition_states_{std::vector<LeaderAndIsrPartitionState>{}}, topic_states_{topic_states}, live_leaders_{live_leaders}, tagged_fields_{tagged_fields} {};
...
struct UpdateMetadataRequest {
  ...
  // constructor used in versions: [0, 1, 2, 3, 4]
  UpdateMetadataRequest(int32_t controller_id, int32_t controller_epoch, std::vector<UpdateMetadataPartitionState> ungrouped_partition_states, std::vector<UpdateMetadataBroker> live_brokers): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{-1}, ungrouped_partition_states_{ungrouped_partition_states}, topic_states_{std::vector<UpdateMetadataTopicState>{}}, live_brokers_{live_brokers}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [5]
  UpdateMetadataRequest(int32_t controller_id, int32_t controller_epoch, int64_t broker_epoch, std::vector<UpdateMetadataTopicState> topic_states, std::vector<UpdateMetadataBroker> live_brokers): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{broker_epoch}, ungrouped_partition_states_{std::vector<UpdateMetadataPartitionState>{}}, topic_states_{topic_states}, live_brokers_{live_brokers}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [6, 7]
  UpdateMetadataRequest(int32_t controller_id, int32_t controller_epoch, int64_t broker_epoch, std::vector<UpdateMetadataTopicState> topic_states, std::vector<UpdateMetadataBroker> live_brokers, TaggedFields tagged_fields): controller_id_{controller_id}, controller_epoch_{controller_epoch}, broker_epoch_{broker_epoch}, ungrouped_partition_states_{std::vector<UpdateMetadataPartitionState>{}}, topic_states_{topic_states}, live_brokers_{live_brokers}, tagged_fields_{tagged_fields} {};
...
struct AddPartitionsToTxnRequest {
  ...
  // constructor used in versions: [0, 1, 2]
  AddPartitionsToTxnRequest(std::string transactional_id, int64_t producer_id, int16_t producer_epoch, std::vector<AddPartitionsToTxnTopic> topics): transactional_id_{transactional_id}, producer_id_{producer_id}, producer_epoch_{producer_epoch}, topics_{topics}, tagged_fields_{TaggedFields({})} {};
  // constructor used in versions: [3]
  AddPartitionsToTxnRequest(std::string transactional_id, int64_t producer_id, int16_t producer_epoch, std::vector<AddPartitionsToTxnTopic> topics, TaggedFields tagged_fields): transactional_id_{transactional_id}, producer_id_{producer_id}, producer_epoch_{producer_epoch}, topics_{topics}, tagged_fields_{tagged_fields} {};
