 ...
 *
 * This file defines the functions kafka_crc32c_init(), kafka_crc32c_update() and
 * kafka_crc32c_finalize().
 *
 ...
 */
static inline kafka_crc32c_t kafka_crc32c_init(void) { return 0xffffffff; }
 ...
 */
static inline kafka_crc32c_t kafka_crc32c_finalize(kafka_crc32c_t crc) { return crc ^ 0xffffffff; }
